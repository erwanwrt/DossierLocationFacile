...
- **Fermeture des candidatures** : La route de dépôt vérifie `forms.is_active` côté serveur avant toute écriture. Un trigger PostgreSQL répète ce contrôle au moment de l’insertion afin d’empêcher les appels directs et les courses avec une fermeture simultanée.
